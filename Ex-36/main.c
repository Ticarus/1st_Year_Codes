...
// This program opens a file named letters.txt and prints A through Z into the file then loops backward through the file printing each of the letters from Z to A.
...
int main()
{
    ...
    fptr = fopen("c:\\users\\ereng\\Documents\\letters.txt","w+");
